                ...
                repos.map(({ name, html_url }, index) => {
                    return (
                        <Link title={name} key={index} href={html_url} referrerPolicy={"no-referrer"} target={"_blank"}>
                            <div className="relative bg-black overflow-hidden w-80 h-40 m-5 rounded-lg hover:scale-110 transition-all ease-in hover:cursor-pointer flex pl-4 items-center ">
